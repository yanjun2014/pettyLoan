...
public class ContactAction extends BaseAction {
	 ...
	 * 查看详细
	 */
	@Action(value = "look", results = { @Result(name = "success", location = "/contact/contact_look.jsp") })
	public String look() {
	...
	public void addContact() {
		...
		String sponsor = this.getRequest().getParameter("sponsor");
		String activity = this.getRequest().getParameter("activity");
		String activityTime = this.getRequest().getParameter("activityTime");
		String activityContent = this.getRequest().getParameter("activityContent");
		String rule = this.getRequest().getParameter("rule");
		String activityAddress = this.getRequest().getParameter("activityAddress");
		...
		try {
			...
			contact.setSponsor(sponsor);
			contact.setActivity(activity);
			contact.setActivityTime(activityTime);
			contact.setActivityContent(activityContent);
			contact.setActivityAddress(activityAddress);
			contact.setRule(rule);
