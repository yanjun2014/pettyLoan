...
<div class="mainbox">
	<div class="box90 bkCenter">
				...
				<div class="infocontent">
					<table id="table1" style="width:100%;" cellpadding="0" cellspacing="0" class="tableList">
	                    <tr>
							...
							<td style="font-weight: bold; border-right: #ccc 1px solid;" align="right">会面时间(不填默认当天)：</td>
		                    <td class="style2" style="padding-top: 2px; padding-left: 2px;">
		                    	<input type="text" id="times" name="times" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH'})" />
		                    	<input id="fileId" type="hidden" value="${fileName.id}" />
		                    </td>
						</tr>
		...
		<div class="box_btn" align="center">
			<input type="button" value="保&nbsp;&nbsp;存" onclick="addMeets()"/> 
