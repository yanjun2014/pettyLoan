...
function excel(){
	...
	/*alert(fbak1);*/
	window.location.href = basePath+"action/fileNames/downExcel?compClass="+compClass+"&fbak1="+fbak1+"&isdelete="+isdelete+"&zipCode="+zipCode+"&userId="+userId;
...
function rvsignFiles(fid,fileId){
	var basePath = $("#basePath").val();
